...
const experienceData: ExperienceItem[] = [
  {
    title: "Colllege Ambassador",
    company: "Valmiki Group ",
    duration: "August 2024- July 2025",
    description: "Worked with the Chrome DevTools team to develop new debugging features for web developers.",
    responsibilities: [
  ...
  },
  {
    ...
    description: "Helped develop and maintain Microsoft's internal design system and component library.",
    responsibilities: [
      "Built reusable UI components using React and TypeScript",
      "Implemented accessibility features following WCAG guidelines",
      "Wrote comprehensive documentation for components",
